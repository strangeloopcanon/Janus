...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyze persona vector layers and injection points")
    ...
    for layer_idx, data in layer_analysis.items():
        if "error" not in data:
            ...
            print(f"    Vector stats - mean: {data['vector_mean']:.4f}, std: {data['vector_std']:.4f}")
