...
def main():
    ...
    parser.add_argument(
        "--demo", choices=["chat", "create", "evaluate"], default="chat", help="Demo type to run"
    )
    ...
    if not available_personas:
        ...
        print(
            "python scripts/create_persona_from_description.py --personality 'formal and professional' --model Qwen/Qwen3-0.6B --output personas/persona_formal.json"
        )
        return
    ...
    if args.demo == "chat":
        ...
        print(
            f"python scripts/run_with_persona.py --model Qwen/Qwen3-0.6B --persona {available_personas[0]} --alpha 1.0"
        )
        ...
        print(
            "python scripts/create_persona_from_description.py --personality 'creative and artistic' --model Qwen/Qwen3-0.6B --output personas/persona_creative.json"
        )
        ...
        print(
            f"python scripts/evaluate_persona_vector.py --model Qwen/Qwen3-0.6B --persona {available_personas[0]} --output results/evaluations/my_evaluation.json --compare"
        )
